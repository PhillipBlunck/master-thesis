...
#############################################################################
##                                                                         ##
## signals.py: Displays all signals from the saved csv-file                ##
##                                                                         ##
## Phillip Blunck, 2021-07-05                                              ##
##                                                                         ##
#############################################################################

NAME = "signals" # Name for picture file
...
def plotdata_date(logger, time, data, signals):
   ...
   for num, signal in enumerate(signals):
      ...
      matplotlib.pyplot.plot_date(x, y, markersize=1)
...
def display(stdin):
   ...
   try:
      ...
      for logger in sorted(loggers):
         ...
         plotlogger(logger, logdata, signals)
